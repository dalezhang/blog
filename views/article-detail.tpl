                    ...
                    <div class="media-body">
                        ...
                        <div> {{$v.Content}}
                            {{if $.isLogin }}
                                <p class="pull-right">
                                    {{if eq $v.Status 0}}
                                        <a href="javascript:;" class="btn btn-danger btn-xs js-comment-status" data-status="1" data-id="{{$v.Id}}">正常</a>
                                    {{else}}
                                        <a href="javascript:;" class="btn btn-danger btn-xs js-comment-status" data-status="0" data-id="{{$v.Id}}">屏蔽</a>
                                    {{end}}
                                </p>
                            {{end}}
                        </div>
